...
function App() {
  ...
  element={
    <>
      <div className="min-h-screen  flex flex-col lg:flex-col items-center justify-cente gap-6  px-6 md:px-16 lg:px-28 mt-16">
      

        {/* Text Content */}
        <div className=" h-auto lg:h-[350px]  flex flex-col items-center justify-center px-6 text-center md:px-16 lg:px-16">
          <div className="space-y-6 text-center">
            <h1 className={`${darkMode ? "text-[#ffffff]" : "text-[#023e7d]"}  md:text-6xl font-semibold leading-tight`}>
